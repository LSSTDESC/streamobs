...
![DES Y6 stellar efficiency and galaxy misclassification](../_static/des_yr6/DES_efficiencies.png)
...
shaded region is clamped rather than measured — see* Known limitations. *The
classification curve rising just faintward of the limit is expected: it is
conditioned on detection, so past the limit it describes the well-measured
survivors of a hard S/N cut.*
...
![DES Y6 truth-anchored depth histograms](../_static/des_yr6/DES_depth.png)

![DES Y6 g-band depth map](../_static/des_yr6/DES_depth_map.png)
